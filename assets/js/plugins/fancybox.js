!function(e, t, i, n) {
    ...
    var a = i("html")
      ...
      , g = function(e, t) {
        ...
        return t && u(e) && (i = r.getViewport()[t] / 100 * i),
        Math.ceil(i)
    }
      , m = function(e, t) {
        return g(e, t) + "px"
    ...
    i.extend(r, {
        ...
        open: function(e, t) {
            ...
            !1 !== r.close(!0)) ? (i.isArray(e) || (e = h(e) ? i(e).get() : [e]),
            i.each(e, function(a, s) {
                ...
                !d && m.isDom && (d = s.data("fancybox-type"),
                d || (u = s.prop("class").match(/fancybox\.(\w+)/),
                d = u ? u[1] : null)),
                p(o) && (d || (r.isImage(o) ? d = "image" : r.isSWF(o) ? d = "swf" : "#" === o.charAt(0) ? d = "inline" : p(s) && (d = "html",
                c = s)),
                "ajax" === d && (f = o.split(/\s+/, 2),
                o = f.shift(),
                g = f.shift())),
        ...
        jumpto: function(e, t, i) {
            ...
            r.router = i || "jumpto",
            a.loop && (0 > e && (e = a.group.length + e % a.group.length),
            e %= a.group.length),
            a.group[e] !== n && (r.cancel(),
            r._start(e)))
        },
        reposition: function(e, t) {
            var n, a = r.current, s = a ? a.wrap : null;
            s && (n = r._getPosition(t),
        ...
        update: function(e) {
            ...
            i && (clearTimeout(c),
            c = null),
            r.isOpen && !c && (c = setTimeout(function() {
                var n = r.current;
        ...
        toggle: function(e) {
            ...
            d && (r.wrap.removeAttr("style").addClass("fancybox-tmp"),
            r.trigger("onUpdate")),
            r.update())
        },
        ...
        bindEvents: function() {
            ...
            e = t.keys,
            e && o.bind("keydown.fb", function(a) {
                ...
                return 27 === s && r.coming ? !1 : (a.ctrlKey || a.altKey || a.shiftKey || a.metaKey || o && (o.type || i(o).is("[contenteditable]")) || i.each(e, function(e, o) {
                    return t.group.length > 1 && o[s] !== n ? (r[e](o[s]),
                    a.preventDefault(),
                    !1) : i.inArray(s, o) > -1 ? (r[e](),
                    a.preventDefault(),
                    !1) : void 0
                }),
                void 0)
        ...
        _start: function(e) {
            ...
            if (r.isActive = !0,
            ("image" === a || "swf" === a) && (l.autoHeight = l.autoWidth = !1,
            l.scrolling = "visible"),
        ...
        _afterLoad: function() {
            ...
            l && r.isActive !== !1) {
                if (!1 === r.trigger("afterLoad", l, c))
                    ...
                    r.coming = null,
                    void 0;
                switch (c && (r.trigger("beforeChange", c),
        ...
        _setDimension: function() {
            ...
            if (j.add(C).add(I).width("auto").height("auto").removeClass("fancybox-tmp"),
            ...
            "iframe" === T.type) {
                if (w = T.content,
                T.autoHeight && 1 === w.data("ready"))
                    try {
                        w[0].contentWindow.document.location && (I.width(s).height(9999),
                        b = w.contents().find("body"),
                        B && b.css("overflow-x", "hidden"),
                        o = b.outerHeight(!0))
                    } catch (E) {}
            } else
                (T.autoWidth || T.autoHeight) && (I.addClass("fancybox-tmp"),
            ...
            l = D,
            c = A,
            T.fitToView && (D = Math.min(y.w - n, D),
            A = Math.min(y.h - a, A)),
            f = y.w - R,
            v = y.h - O,
            T.aspectRatio ? (S > D && (S = D,
            W = g(S / d)),
            W > A && (W = A,
            S = g(W * d)),
            H > S && (S = H,
            W = g(S / d)),
            L > W && (W = L,
            S = g(W * d))) : (S = Math.max(H, Math.min(S, D)),
            T.autoHeight && "iframe" !== T.type && (I.width(S),
            W = I.height()),
            W = Math.max(L, Math.min(W, A))),
            T.fitToView)
                if (I.width(S).height(W),
                j.width(S + e),
                h = j.width(),
                p = j.height(),
                T.aspectRatio)
        ...
        _afterZoomIn: function() {
            ...
            r.update(),
            (e.closeClick || e.nextClick && r.group.length > 1) && r.inner.css("cursor", "pointer").bind("click.fb", function(t) {
    ...
    r.transitions = {
        getOrigPosition: function() {
            ...
            i.length || (i = t)),
            h(i) ? (n = i.offset(),
            i.is("img") && (a = i.outerWidth(),
            s = i.outerHeight())) : (n.top = c.y + (c.h - s) * e.topRatio,
        ...
        changeIn: function() {
            ...
            "down" === s || "right" === s ? (n[e] = m(g(n[e]) - o),
            a[e] = "+=" + o + "px") : (n[e] = m(g(n[e]) + o),
            a[e] = "-=" + o + "px")),
            "none" === i ? r._afterZoomIn() : r.wrap.css(n).animate(a, {
    ...
    r.helpers.overlay = {
        ...
        onReady: function(e, t) {
            ...
            n || this.create(e),
            e.locked && this.fixed && t.fixed && (n || (this.margin = o.height() > s.height() ? i("html").css("margin-right").replace("px", "") : !1),
    ...
    r.helpers.title = {
        ...
        beforeShow: function(e) {
            ...
            if (i.isFunction(s) && (s = s.call(a.element, a)),
            p(s) && "" !== i.trim(s)) {
    ...
    i.fn.fancybox = function(e) {
        var t, n = i(this), a = this.selector || "", s = function(s) {
            ...
            l || (o = "rel",
            l = c.get(0)[o]),
            l && "" !== l && "nofollow" !== l && (c = a.length ? i(a) : n,
            c = c.filter("[" + o + '="' + l + '"]'),
            d = c.index(this)),
            e.index = d,
